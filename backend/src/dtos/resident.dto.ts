...
export const getResidentsQuerySchema = z.object({
  ...
  residenceStatus: z
    .enum([ResidenceStatus.RESIDENCE, ResidenceStatus.NO_RESIDENCE])
    .optional(),
...
export const createOneResidentBodySchema = z.object({
  ...
  isHouseholder: z.enum([
    HouseholdType.HOUSEHOLDER,
    HouseholdType.HOUSEMEMBER,
  ]),
});
...
export const updateResidentBodySchema = z
  .object({
    ...
    isHouseholder: z
      .enum([HouseholdType.HOUSEHOLDER, HouseholdType.HOUSEMEMBER])
      .optional(),
  })
